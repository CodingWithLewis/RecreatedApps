  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ImageUploadsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ImageUploadsRecord> createPhotoImageUploadsRecordList =
            snapshot.data!;
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final photos =
                              createPhotoImageUploadsRecordList.toList();
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (await getPermissionStatus(
                            ...
                            _model.apiResultic6 = await AnalyzeImageCall.call(
                              userId: currentUserUid,
                              image: _model.uploadedLocalFile,
                            );
                            if ((_model.apiResultic6?.succeeded ?? true)) {
                              await queryImageUploadsRecordOnce(
                                queryBuilder: (imageUploadsRecord) =>
                                    imageUploadsRecord.where(
                                  'id',
                                  isEqualTo: AnalyzeResponseStruct.maybeFromMap(
                                          (_model.apiResultic6?.jsonBody ?? ''))
                                      ?.id,
                                ),
                                singleRecord: true,
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'imageID': serializeParam(
                                    createPhotoImageUploadsRecordList
                                        .first.reference,
                                    ParamType.DocumentReference,
                                  ),
                                }.withoutNulls,
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Photo Library Required to do anything...',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryText,
                                  ),
