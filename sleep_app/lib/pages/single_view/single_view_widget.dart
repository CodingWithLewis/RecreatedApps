...
class _SingleViewWidgetState extends State<SingleViewWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SleepScoresRecord>(
      stream: SleepScoresRecord.getDocument(widget.scan!),
      builder: (context, snapshot) {
        ...
        final singleViewSleepScoresRecord = snapshot.data!;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                'Sleep on ${dateTimeFormat('d/M/y', singleViewSleepScoresRecord.scannedAt)}',
                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${singleViewSleepScoresRecord.sleepScore.toString()}%',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .displaySmall,
                                                                      ),
                                                                    ),
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(16.0, 4.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Below is an overview of the entire night.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium,
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: StreamBuilder<
                                                              List<
                                                                  GraphDataRecord>>(
                                                            stream:
                                                                queryGraphDataRecord(
                                                              parent:
                                                                  singleViewSleepScoresRecord
                                                                      .reference,
                                                              queryBuilder: (graphDataRecord) =>
                                                                  graphDataRecord
                                                                      .orderBy(
                                                                          'time'),
                                                            ),
